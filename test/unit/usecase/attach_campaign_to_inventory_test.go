...
func (m *mockAttachCampaignInventoryRepo) FindByPromotionID(promotionID string) ([]*entity.Inventory, error) {
	return nil, nil
}
...
func (m *mockAttachCampaignPromotionRepo) FindExpired(now time.Time) ([]*entity.Promotion, error) {
	return nil, nil
}
